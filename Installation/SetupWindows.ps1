...
Step "Reboot your phone. Select BootShim. Windows 10 ARM Setup should begin!`nPlease, COMPLETE THE WINDOWS SETUP until it boots to the Desktop screen."
Scripted-Step "We  going to enable Dual Boot.`nPlease, switch to Mass Storage Mode before proceeding." "$($PSScriptRoot)\EnableDualBoot.ps1"
